package com.ronething.course.service;

import com.alibaba.dubbo.config.annotation.Service;
import com.ronething.course.dto.CourseDTO;
import com.ronething.course.mapper.CourseMapper;
import com.ronething.thrift.user.UserInfo;
import com.ronething.thrift.user.dto.TeacherDTO;
...
public class CourseServiceImpl implements ICourseService {
    ...
    public List<CourseDTO> courseList() {
        List<CourseDTO> courseDTOList = courseMapper.listCourse();
